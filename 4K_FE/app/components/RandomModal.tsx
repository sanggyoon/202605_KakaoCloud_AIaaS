    ...
    >
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(160deg, #14161c, #0a0b10)',
        ...
        {picked && (
          <div
            style={{
              display: 'grid',
              gridTemplateColumns:
                'clamp(118px, 14vw, 170px) minmax(0, 1fr)',
              gap: 'clamp(16px, 3vw, 28px)',
              alignItems: 'flex-start',
              transform: shuffling
                ? `rotate(${rolls % 2 === 0 ? -2 : 2}deg) scale(0.96)`
                : 'rotate(0) scale(1)',
          ...
          >
            ...
            >
              ...
              >
                {picked.release_year}
                {picked.runtime ? ` · ${picked.runtime}분` : ''}
              </div>
              ...
              >
                {genres.map((g) => (
                  <span
                    ...
                    style={{
                      padding:
                        'clamp(4px, 0.8vw, 5px) clamp(8px, 1.2vw, 10px)',
        ...
        >
          <button
            ...
            style={{
              ...
              gap: 6,
              padding:
                'clamp(10px, 1.5vw, 13px) clamp(14px, 2vw, 18px)',
              background: 'rgba(255,255,255,0.04)',
